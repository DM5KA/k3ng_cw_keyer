// This file is for the Ultraboob Interface of DM4WH
...
#define potentiometer_enable_pin 0  // if defined, the potentiometer will be enabled only when this pin is held low; set to 0 to ignore this pin
	...
	#define command_mode_active_led 6
...
// rotary encoder pins and options - rotary encoder code from Jim Balls M0CKE
	...
	#define led_ring_sdi    0 //2    //Data
	#define led_ring_clk    0 //3    //Clock
	#define led_ring_le     0 //4    //Latch
...
#define cw_decoder_indicator 7       // Output - goes HIGH when cw tone is detected by OPTION_CW_DECODER_GOERTZEL_AUDIO_DETECTOR
